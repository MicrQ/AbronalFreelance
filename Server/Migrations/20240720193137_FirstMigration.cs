        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SysCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyEstablishedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Clients_Locations_CompanyLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Flags_AspNetUsers_ReportedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreelancerEducations", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FreelancerEducations_EducationLevels_EducationLevelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreelancerPools", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FreelancerPools_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FreelancerPools_AspNetUsers_FreelancerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    skilledAt = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FreelancerSkills_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoriteFlag = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Applications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Applications_AspNetUsers_FreelancerId",
                        column: x => x.FreelancerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobFields_Fields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "Fields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobOffers_AspNetUsers_FreelancerId",
                        column: x => x.FreelancerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobPools", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobPools_AspNetUsers_FreelancerId",
                        column: x => x.FreelancerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobPools_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobStatuses_ApprovalStatuses_ApprovalStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillsForJobs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SkillsForJobs_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SkillsForJobs_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationStatuses_ApprovalStatuses_ApprovalStatusId",
                        column: x => x.ApprovalStatusId,
                        principalTable: "ApprovalStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Duration = table.Column<TimeSpan>(type: "time", nullable: false),
                    LinkForMeeting = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractStatusTypeId = table.Column<int>(type: "int", nullable: false),
                    DateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContractStatuses_Contracts_ContractId",
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ContractStatusTypeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationStatuses_ApprovalStatusId",
                table: "ApplicationStatuses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_CompanyLocationId",
                table: "Clients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContractStatuses_ContractId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FreelancerEducations_EducationLevelId",
                table: "FreelancerEducations",
                column: "EducationLevelId");

            migrationBuilder.CreateIndex(
                name: "IX_FreelancerEducations_FieldId",
                table: "FreelancerEducations",
                column: "FieldId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FreelancerPools_ClientId",
                table: "FreelancerPools",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_FreelancerPools_FreelancerId",
                table: "FreelancerPools",
                column: "FreelancerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FreelancerSkills_UserId",
                table: "FreelancerSkills",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobOffers_FreelancerId",
                table: "JobOffers",
                column: "FreelancerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPools_FreelancerId",
                table: "JobPools",
                column: "FreelancerId");

            migrationBuilder.CreateIndex(
                name: "IX_JobPools_JobId",
                table: "JobPools",
                column: "JobId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobStatuses_ApprovalStatusId",
                table: "JobStatuses",
                column: "ApprovalStatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkillsForJobs_JobId",
                table: "SkillsForJobs",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillsForJobs_SkillId",
                table: "SkillsForJobs",
                column: "SkillId");
        }
